...
echo_and_run cd "/home/lifanjie/ShenLanAcademy-PlanningAndControl/src/carla_ros_bridge_ros/src/carla_waypoint_publisher"
...
echo_and_run /usr/bin/env \
    ...
    "/home/lifanjie/ShenLanAcademy-PlanningAndControl/src/carla_ros_bridge_ros/src/carla_waypoint_publisher/setup.py" \
     \
    build --build-base "/home/lifanjie/ShenLanAcademy-PlanningAndControl/build/carla_ros_bridge_ros/src/carla_waypoint_publisher" \
    install \
    --root="${DESTDIR-/}" \
