...
echo_and_run cd "/home/lifanjie/ShenLanAcademy-PlanningAndControl/src/carla_ros_bridge_ros/src/carla_common"
...
echo_and_run /usr/bin/env \
    ...
    "/home/lifanjie/ShenLanAcademy-PlanningAndControl/src/carla_ros_bridge_ros/src/carla_common/setup.py" \
     \
    build --build-base "/home/lifanjie/ShenLanAcademy-PlanningAndControl/build/carla_ros_bridge_ros/src/carla_common" \
    install \
    --root="${DESTDIR-/}" \
