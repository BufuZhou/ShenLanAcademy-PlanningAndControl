...
echo_and_run cd "/home/lifanjie/ShenLanAcademy-PlanningAndControl/src/carla_ros_bridge_ros/src/carla_ros_scenario_runner"
...
echo_and_run /usr/bin/env \
    ...
    "/home/lifanjie/ShenLanAcademy-PlanningAndControl/src/carla_ros_bridge_ros/src/carla_ros_scenario_runner/setup.py" \
     \
    build --build-base "/home/lifanjie/ShenLanAcademy-PlanningAndControl/build/carla_ros_bridge_ros/src/carla_ros_scenario_runner" \
    install \
    --root="${DESTDIR-/}" \
